...
\note[itemize]{
	...
	\item Do a quick demo pull request.
...
\end{frame}
\note[itemize]{
	\item Now ``cd /workspaces/workshop-codemash-2023/bin'' and type ``terraform-install.sh''
}
...
\end{frame}
\note[itemize]{
	\item absolutely 100 percent totally ripped this off from https://gmusumeci.medium.com/how-to-create-a-service-account-for-terraform-in-gcp-google-cloud-platform-f75a0cf918d1
...
\end{frame}
\note[itemize]{
	\item quick detour of storing passwords with pass
}
