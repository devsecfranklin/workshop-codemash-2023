...
def main(request):
    ...
    g = Github(token)
    my_gh_helper = github_util.GithubHelper(label_name)
    logger.info("Instantiate GH object with label %s", my_gh_helper.label_name)
    ...
    if request_json and "message" in request_json:
        ...
        my_result = my_gh_helper.check_pr_label(g)  # add label to the PR if missing
...
"""
Authors:      Franklin D. <2730246+devsecfranklin@users.noreply.github.com>
