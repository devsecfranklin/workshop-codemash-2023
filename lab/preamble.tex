...
\newcommand{\mytitle}{Build a Serverless Github Bot in GCP}
\usepackage{authblk}
...
\pagestyle{fancy}
\fancyhf{}
\lhead{Build a Serverless Github Bot in GCP}
\lfoot{\tiny{October 02, 2022}}
...
% This allows us to include Markdown files as code blocks, faster to edit and update than codeblocks
